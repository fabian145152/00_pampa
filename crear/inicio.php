    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <table class="table table-sm" id="table_2">
            ...
            <!--    <td class="primera_fila">Id</td> -->
                ...
                <td class="primera_fila">Chofer Dia</td>
                <td class="primera_fila">Direccion</td>
                <td class="primera_fila">CP</td>
                <td class="primera_fila">Celular</td>
                <td class="primera_fila">DNI</td>
            ...
            */
            ...
            ?>
                ...
                <tr>
                   <!-- <td><?php  $persona->id ?> </td>  -->
                    ...
                    <td><?php echo $persona->licencia_titular ?></td>
                    ...
                    <td class='bot'><a href="editar.php?id=<?php echo $persona->id ?> 
                                                       ...
                                                       & licencia_titular=<?php echo $persona->licencia_titular ?>
            ...
            <tr>
                ...
                <td><input type="text" name="Licencia_titular" size="5" class='centrado' disabled></td>
