...
<body>
    ...
    if (!isset($_POST["bot_actualizar"])) {
        ...
        $licencia_titular = $_GET['licencia_titular'];
        ...
        $sql = "UPDATE unidades SET fecha_ini=:miFecha_ini,
                                    ...
                                    licencia_titular=:miLicencia_titular,
        ...
        $resultado->execute(array(
            ...
            ":miLicencia_titular" => $licencia_titular,
    ...
    <form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        ...
        <table width="35%" border="1" align="center">
            ...
            <tr>
                ...
                <td><label for="licencia_titular"></label>
                    <input type="text" name="licencia_titular" id="licencia_titular" value="<?php echo $licencia_titular ?>">
                </td>
            </tr>
        ...
        <tr>
            <td colspan="2"><input type="submit" class="boton" name="bot_actualizar" id="bot_actualizar" value="Actualizar"></td>
        </tr>
    </form>
    <p>&nbsp;</p>
