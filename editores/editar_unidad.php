...
-->
        ...
        <table width="35%" border="0" align="center">
            ...
            <tr>
                ...
                <td>
                    ...
                    <select name="abono" id="abono" class="form-control">

                        <option value="Semanaporte">Porteño</option>
                        <option value="Semanapampa">Pampa</option>
                        <option value="SemanaBsAS">Buenos Aires</option>
                    </select>
    ...
    <p>&nbsp;</p>
    <a href="inicio.php">Volver al listado</a>
    <br>
